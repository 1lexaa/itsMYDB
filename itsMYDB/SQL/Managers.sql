...
-- FROM Managers M JOIN Departments D ON M.Id_main_dep = D.Id
-- ORDER BY D.Name ASC
 
-- -- Сотрудники у которых есть начальник
-- -- [Фамилия сотрудника] [Имя сотрудника] [Фамилия начальника] [Имя начальника]
-- SELECT 
-- 	Manager.Surname [Фамилия сотрудника],
-- 	Manager.Name [Имя сотрудника],
-- 	Mayor.Surname [Фамилия начальника],
-- 	Mayor.Name [Имя начальника]
-- FROM 
-- 	Managers Manager
-- 	JOIN Managers Mayor
-- 		ON Manager.Id_chief = Mayor.Id
-- ORDER BY 
-- 	Mayor.Name ASC 
